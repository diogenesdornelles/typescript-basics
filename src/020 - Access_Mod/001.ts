// public acessível dentro e fora da classe, em qualquer contexto. Acesso padrão, não precisa ser declarado.
// private somente dentro da própria classe, não se estende por herança para subclasse.
// protected. Autoriza que somente que a própria classe e suas subclasses tenham acesso.
